...
public class SportsFragment extends Fragment implements NewsCardAdapter.OnCardListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressLayout = view.findViewById(R.id.progressLayoutSports);
        progressLayout.setVisibility(View.VISIBLE);

        swipeRefreshLayout = view.findViewById(R.id.sportsSwipeRefreshLayout);
    ...
    public void getLatestNews(final VolleyNewsCallback callback){
        String url = "http://hw9server.eba-rnemrspm.us-east-1.elasticbeanstalk.com/api/guardian?section=sport";
