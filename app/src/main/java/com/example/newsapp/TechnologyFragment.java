...
public class TechnologyFragment extends Fragment implements NewsCardAdapter.OnCardListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressLayout = view.findViewById(R.id.progressLayoutTechnology);
        progressLayout.setVisibility(View.VISIBLE);

        swipeRefreshLayout = view.findViewById(R.id.techSwipeRefreshLayout);
    ...
    public void getLatestNews(final VolleyNewsCallback callback){
        String url = "http://hw9server.eba-rnemrspm.us-east-1.elasticbeanstalk.com/api/guardian?section=technology";
