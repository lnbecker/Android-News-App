...
public class HomeFragment extends Fragment implements NewsCardAdapter.OnCardListener {
    ...
    private void getLatestNews(final VolleyNewsCallback callback){
        String url = "http://hw9server.eba-rnemrspm.us-east-1.elasticbeanstalk.com/api/guardian";
