...
public class WorldFragment extends Fragment implements NewsCardAdapter.OnCardListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressLayout = view.findViewById(R.id.progressLayoutWorld);
        progressLayout.setVisibility(View.VISIBLE);

        swipeRefreshLayout = view.findViewById(R.id.worldSwipeRefreshLayout);
    ...
    public void getLatestNews(final VolleyNewsCallback callback){
        String url = "http://hw9server.eba-rnemrspm.us-east-1.elasticbeanstalk.com/api/guardian?section=world";
